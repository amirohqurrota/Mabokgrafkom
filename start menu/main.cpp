...
void menu() {
    ...
    glVertex2f(56.8688312322439, 36.6002343749999);//R
    glVertex2f(71.9872971413351, 36.6002343749999);//S
    glVertex2f(71.8837460049714, 29.5587571022725);//T
    glVertex2f(56.8688312322439, 29.4552059659088);//U


    glEnd();
    glColor3f(1,1,1);
    drawText(61.1050140834839, 32.8465056818181,"START");
